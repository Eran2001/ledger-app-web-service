...
| Class | Description | Example |
| --- | --- | --- |
| `fw-normal` | weight 400 | `<p className="t-body fw-normal">Text</p>` |
| `fw-medium` | weight 500 | `<p className="t-body fw-medium">Text</p>` |
| `fw-semibold` | weight 600 | `<p className="t-body fw-semibold">Text</p>` |
| `fw-bold` | weight 700 | `<p className="t-body fw-bold">Text</p>` |
| `fw-black` | weight 900 | `<p className="t-body fw-black">Text</p>` |

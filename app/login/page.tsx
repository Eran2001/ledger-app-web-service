...
import { BarChart3, Bell, Eye, EyeOff, FileText, type LucideIcon } from "lucide-react"
    ...
    <div className="min-h-screen flex flex-col lg:flex-row surface-page">
      ...
      <div className="w-full lg:w-[45%] flex items-center justify-center p-6 sm:p-12">
        <div className="w-full max-w-md">
          ...
          <p className="t-body text-soft mb-8">Sign in to your admin panel to manage your business.</p>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-5">
            ...
            <div className="flex flex-col gap-2">
              <div className="flex items-center justify-between">
                ...
                <Link href="/setup-password" className="t-caption-bold text-brand hover:underline">
                  Forgot password?
                </Link>
              </div>
          ...
          <p className="mt-8 t-meta text-soft text-center">
            Need access?{" "}
            <Link href="/register" className="text-brand fw-bold hover:underline">
              Request access →
            </Link>
          </p>
        </div>

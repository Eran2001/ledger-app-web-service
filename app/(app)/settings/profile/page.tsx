  ...
  return (
    <div className="space-y-6 max-w-3xl">
      <div className="card-base p-6 flex items-center gap-5">
        <InitialsAvatar name={form.name} size={80} />
      ...
      <form onSubmit={save} className="card-base p-6">
        ...
        <p className="t-caption text-soft mb-6">Your basic profile information.</p>
      ...
      <div className="card-base p-6" style={{ borderColor: "color-mix(in srgb, var(--destructive) 30%, transparent)" }}>

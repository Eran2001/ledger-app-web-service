                    ...
                    >
                      ...
                      <td className="px-4 py-3">
                        <div className="flex items-center gap-3">
                          <InitialsAvatar name={r.customerName} size={36} />
                      ...
                      <td className="px-4 py-3">
                        <div className="flex items-center gap-1 justify-end">
                          <Button
                            size="sm"
                            variant="outline"
                            onClick={() => toast.success(`Reminder sent to ${r.customerName}`)}
                            className="gap-1.5"
                          >
        ...
        <div className="fixed bottom-6 left-1/2 -translate-x-1/2 z-50 animate-in slide-in-from-bottom-4">
          <div className="app-sidebar modal-rounded shadow-2xl px-4 py-3 flex items-center gap-4">
            ...
            <div className="flex items-center gap-2">
              ...
              <Button
                onClick={() => {
                  toast.success(`WhatsApp reminders sent to ${selected.size} customers`)
                  setSelected(new Set())
                }}
                className="surface-brand text-inverse surface-brand-strong-hover gap-2"
              >

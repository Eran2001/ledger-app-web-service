...
export default function ReportsPage() {
  ...
  const pieData = [
    ...
    { name: "PARTIAL", value: stats.statusCounts.PARTIAL, color: "var(--warning)" },
    { name: "OVERDUE", value: stats.statusCounts.OVERDUE, color: "var(--destructive)" },
  ]
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="card-base p-5">
          ...
          <p className="t-kpi-lg text-main mt-2">{formatCurrency(stats.totalOutstanding)}</p>
        ...
        <div className="card-base p-5">
          ...
          <p className="t-caption text-soft mt-1">{format(new Date(), "MMMM yyyy")}</p>
        </div>
        <div className="card-base p-5">
      ...
      <div className="card-base overflow-hidden">
        <div className="px-5 py-4 border-b" style={{ borderColor: "var(--border)" }}>
          ...
          <p className="t-caption text-soft">Customers with unpaid past-due installments</p>
        </div>
          ...
          <table className="w-full">
            ...
            <tbody>
              {overdueRows.length === 0 ? (
                <tr>
                  <td colSpan={5} className="px-4 py-12 align-text-center t-meta text-faint">
                ...
                overdueRows.slice(0, 10).map((r) => {
                  ...
                  return (
                    <tr key={r.id} className="border-t" style={{ borderColor: "var(--border)" }}>
                      <td className="px-4 py-3 table-title-text">{r.customerName}</td>
                      <td className="px-4 py-3 table-text">{r.productName}</td>
                      <td className={`px-4 py-3 fw-black ${sevText}`}>{r.daysOverdue} days</td>

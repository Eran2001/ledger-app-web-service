        ...
        {submitted ? (
          <div className="text-center py-10">
            <div className="surface-success-soft circle-rounded h-16 w-16 mx-auto flex items-center justify-center mb-5">
              <CheckCircle2 className="h-8 w-8 text-success-role" strokeWidth={2} />
            </div>
            ...
            <Link href="/login" className="t-meta-bold text-brand hover:underline">
              ← Back to sign in
            </Link>
          </div>
        ) : (
          <>
            ...
            <form onSubmit={handleSubmit} className="grid gap-5">
              <div className="flex flex-col gap-2">
                ...
                <Input id="name" required className="h-11 control-rounded border-default" placeholder="Jane Doe" />
              </div>
              ...
              <div className="grid sm:grid-cols-2 gap-5">
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <Input id="phone" required className="h-11 control-rounded border-default" placeholder="+94 77 123 4567" />
                </div>
              </div>
              ...
              <div className="flex flex-col gap-2">
                ...
                <Select defaultValue="STAFF">
                  ...
                  <SelectContent>
                    <SelectItem value="STAFF">STAFF — record sales and payments</SelectItem>
              ...
              <p className="t-meta text-soft text-center mt-2">
                Already have access?{" "}
                <Link href="/login" className="text-brand fw-bold hover:underline">
                  Sign in
                </Link>
              </p>
            </form>

            ...
            <div className="xl:col-span-3 space-y-8">
              <div className="bg-white rounded-2xl border border-[#E2E8F0] shadow-sm overflow-hidden flex flex-col">
                <div className="p-6 border-b border-[#E2E8F0] flex items-center justify-between">
                  ...
                  <Button
                    variant="outline"
                    className="h-9 border-[#4F46E5] text-[#4F46E5] font-bold text-xs hover:bg-[#EEF2FF]"
                  >
                          ...
                          <td className="px-5 py-4">
                            <div className="flex items-center gap-3">
                              ...
                              <div className="flex flex-col overflow-hidden">
                                <span className="text-sm font-bold text-[#0F172A] truncate leading-tight">
                                  {u.name}
                                </span>
              ...
              <div className="bg-white rounded-2xl border border-[#E2E8F0] shadow-sm p-6">
                ...
                <div className="space-y-4">
                  {pendingRegistrations.map((p) => (
                    <div
                      key={p.id}
                      className="p-4 bg-slate-50 border border-slate-100 rounded-xl flex flex-col md:flex-row md:items-center justify-between gap-4 group hover:border-[#4F46E5] hover:bg-indigo-50/20 transition-all"
                    >
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          <div className="flex items-center gap-2">
                            ...
                            <span className="text-[10px] bg-white border border-slate-200 px-1.5 py-0.5 rounded text-slate-500 font-bold uppercase tracking-tighter shadow-sm">
                              {p.requestedRole}
                            </span>
                          </div>
                          <div className="flex flex-wrap items-center gap-x-3 gap-y-1 mt-0.5">
                            <span className="text-[11px] text-[#475569] flex items-center gap-1 font-medium">
                      ...
                      <div className="flex gap-2 shrink-0">
                        <Button className="h-8 px-4 bg-green-500 hover:bg-green-600 text-[11px] font-bold rounded-lg shadow-sm shadow-green-100">
                          Approve
                        </Button>
                        <Button
                          variant="outline"
                          className="h-8 px-4 border-slate-200 text-red-500 hover:bg-red-50 text-[11px] font-bold rounded-lg"
                        >
                          Reject
                        </Button>
                      </div>
              ...
              <div className="bg-white rounded-2xl border border-[#E2E8F0] shadow-sm p-6 h-full">
                ...
                <div className="overflow-x-auto">
                  <table className="w-full text-left">
                    <thead>
                      <tr>
                        <th className="py-3 text-[10px] uppercase font-black tracking-widest text-[#94A3B8]">
                          Permission
                        </th>
                        <th className="py-3 px-2 text-center text-[10px] uppercase font-black tracking-widest text-indigo-500 bg-indigo-50/50 rounded-t-lg">
                          Admin
                        </th>
                        <th className="py-3 px-2 text-center text-[10px] uppercase font-black tracking-widest text-purple-500">
                          Staff
                        </th>
                        <th className="py-3 px-2 text-center text-[10px] uppercase font-black tracking-widest text-slate-400">
                          View
                        </th>
                      </tr>
                    </thead>
                    <tbody className="divide-y divide-slate-50">
                      {[
                        ...
                        <tr
                          ...
                          className="hover:bg-slate-50 transition-colors"
                        >
                          <td className="py-3 text-xs font-bold text-[#475569]">
                            {perm.p}
                          </td>
          ...
          <div className="max-w-4xl space-y-8 animate-in fade-in duration-300">
                ...
                <div className="flex items-center gap-6">
                  ...
                  <div className="flex flex-col">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="px-2 py-0.5 rounded-full bg-green-100 text-green-700 text-[10px] font-black uppercase tracking-widest border border-green-200">
                        Connected
                      </span>
                    </div>
                    ...
                    <span className="text-xs text-[#94A3B8] font-bold uppercase tracking-tight">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {[
                ...
                <div
                  key={idx}
                  className="bg-white rounded-2xl border border-[#E2E8F0] p-6 shadow-sm flex flex-col"
                >
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <Button
                      variant="ghost"
                      size="sm"
                      className="h-8 text-[#4F46E5] font-bold hover:bg-indigo-50"
                    >
                      Edit
                    </Button>
                  </div>
                  <div className="bg-slate-50 rounded-xl p-4 border border-slate-100/50 flex flex-col flex-1">
                    <p className="text-xs text-[#475569] leading-relaxed font-mono whitespace-pre-wrap flex-1">
                      {t.text}
                    </p>
            ...
            <div className="bg-white rounded-2xl border border-[#E2E8F0] shadow-sm p-6">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <Button className="bg-[#4F46E5] hover:bg-primary-dark h-12 px-8 font-bold shadow-lg shadow-indigo-100">
                  Send Test
                </Button>
              </div>
            ...
            <div className="bg-white rounded-2xl border border-[#E2E8F0] shadow-sm p-8">
              ...
              <div className="flex flex-col items-center mb-10">
                <div className="w-24 h-24 rounded-3xl bg-[#EEF2FF] border-2 border-dashed border-[#4F46E5]/40 flex flex-col items-center justify-center cursor-pointer group hover:bg-[#EEF2FF]/80 transition-all shadow-xl shadow-indigo-50/50">
                  <span className="text-3xl font-black text-[#4F46E5] italic">
                    ST
                  </span>
              ...
              <form className="space-y-6">
                  ...
                  <div className="space-y-1.5">
                    ...
                    <div className="relative">
                      <InitialsAvatar
                        name="Kamal Silva"
                        size="sm"
                        className="absolute left-2.5 top-1/2 -translate-y-1/2 w-6 h-6 text-[8px]"
                      />
                      <Input
                ...
                <div className="pt-6 border-t border-slate-50 flex justify-end">
                  <Button className="bg-[#4F46E5] hover:bg-primary-dark px-10 h-12 font-bold shadow-lg shadow-indigo-100">
                    Save Changes
                  </Button>
                </div>
              </form>

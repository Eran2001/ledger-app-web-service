...
const initialTemplates: WhatsAppTemplate[] = [
  ...
  },
  {
    id: "t2",
    name: "Overdue Notice",
    preview: "Hi {customer}, your payment of {amount} is overdue by {days} days.",
    active: true,
  },
  {
    id: "t3",
...
function BusinessForm() {
  ...
  return (
    <form onSubmit={handleSave} className="card-base p-6 max-w-3xl">
      ...
      <p className="t-caption text-soft mb-6">Used on receipts, reminders, and customer communications.</p>
      ...
      <div className="mt-6 flex justify-end">
        <Button type="submit" className="surface-brand text-inverse surface-brand-strong-hover gap-2">
    ...
    <div className="space-y-4 max-w-4xl">
      <div className="card-base p-5 flex items-center gap-4">
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="t-caption text-soft">
            Connected to <span className="mono-text">+94 77 123 4567</span> · Active templates will be used for reminders.
          </p>
        </div>
        <Button variant="outline" onClick={() => toast.success("Reconnecting...")}>
          Reconnect
        </Button>
      </div>
      ...
      <div className="card-base overflow-hidden">
        <div className="px-5 py-4 border-b" style={{ borderColor: "var(--border)" }}>
          ...
          <p className="t-caption text-soft">Toggle which templates are available for reminders.</p>
        </div>
          ...
          <tbody>
            {templates.map((t) => (
              <tr key={t.id} className="border-t" style={{ borderColor: "var(--border)" }}>
                ...
                <td className="px-4 py-3 t-meta text-soft mono-text">{t.preview}</td>

  ...
  return (
    <div className="flex flex-col h-full surface-page">
      <TopBar
        ...
        primaryAction={{ to: "/customers/new", icon: Plus, label: "New Customer" }}
      />
        ...
        <div className="flex flex-wrap items-center gap-3 mb-5">
          ...
          <Tabs value={tab} onValueChange={(v) => setTab(v as Tab)}>
            <TabsList className="surface-tab-list h-10 p-1 tab-rounded">
              <TabsTrigger value="all" className="tabs-trigger px-3 tab-rounded">All Customers</TabsTrigger>
              <TabsTrigger value="active" className="tabs-trigger px-3 tab-rounded">Active Sales</TabsTrigger>
              <TabsTrigger value="overdue" className="tabs-trigger px-3 tab-rounded">Has Overdue</TabsTrigger>
            </TabsList>
          </Tabs>
                    ...
                    >
                      ...
                      <td className="px-6 py-3 align-text-right">
                        <Button
                          variant="outline"
                          size="sm"
                          onClick={(e) => { e.stopPropagation(); navigate({ to: "/customers/$id", params: { id: c.id } }) }}

        ...
        <div className="bg-white rounded-2xl border border-[#E2E8F0] p-8 mb-8 shadow-sm relative overflow-hidden">
          ...
          <div className="relative z-10 flex flex-col md:flex-row items-center md:items-start gap-8">
            <InitialsAvatar
              ...
              size="lg"
              className="shadow-xl shadow-indigo-100 ring-4 ring-white"
            />
            ...
            {activeSales.length > 0 ? (
              activeSales.map((sale) => {
                ...
                return (
                  <div
                    key={sale.id}
                    className="bg-white rounded-xl border border-[#E2E8F0] p-6 shadow-sm hover:shadow-md transition-shadow"
                  >
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 gap-y-4 text-sm font-medium mb-6">
                      <div className="flex flex-col">
                        <span className="text-[10px] text-[#94A3B8] uppercase tracking-wider mb-0.5">
                          Sold Price
                        </span>
            ...
            <table className="w-full text-left">
              ...
              <tbody className="divide-y divide-[#E2E8F0]">
                <tr className="hover:bg-slate-50">
                  ...
                  <td className="px-5 py-4 text-sm font-bold text-[#4F46E5]">
                    LKR 3,500
                  </td>
                  <td className="px-5 py-4 text-sm text-[#475569]">
                    Kamal Silva

...
const NotFound = () => {
  ...
  useEffect(() => {
    document.title = "Dunner | Page Not Found";
  }, []);
  ...
  return (
    ...
    >
      ...
      <main ref={cardRef} className="unauthorized-main">
        <div className="unauthorized-lock-wrap unauthorized-fade unauthorized-stagger-1">
          <div className="unauthorized-aura-ring unauthorized-aura-ring-soft" />
          <div className="unauthorized-aura-ring unauthorized-aura-ring-pulse" />
          <div className="unauthorized-glow" />
          <div className="unauthorized-orbit unauthorized-orbit-wide" />
          <div className="unauthorized-orbit unauthorized-orbit-slow" />
          <div className="unauthorized-orbit unauthorized-orbit-reverse" />
          <div className="unauthorized-lock-card">
            <Icon.FileX className="unauthorized-lock-icon" />
          </div>
        </div>
